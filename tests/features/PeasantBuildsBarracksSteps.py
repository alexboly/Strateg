...
def order_the_first_peasant_to_build_barracks(step):
    ...
    UnitActions.buildBarracks(world.game, world.game.getFirstPlayer(), world.peasant, Position("barracksPosition"))
...
def barracks_is_built_at_position_position(step, position):
    world.peasant = world.game.getFirstPlayer().getPeasant()
    UnitActions.buildBarracks(world.game, world.game.getFirstPlayer(), world.peasant, position)
